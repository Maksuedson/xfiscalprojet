...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // If ok, the onAuthStateChange will set user, triggering the useEffect above
  };
        ...
        <div className="bg-card border border-border rounded-2xl shadow-card p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input id="usuario" placeholder="Digite seu usuário" value={usuario} onChange={(e) => setUsuario(e.target.value)} autoFocus />
            </div>

            <div className="space-y-2">
              <Label htmlFor="senha">Senha</Label>
              <div className="relative">
                <Input id="senha" type={showPassword ? "text" : "password"} placeholder="Digite sua senha" value={senha} onChange={(e) => setSenha(e.target.value)} className="pr-10" />
          ...
          <div className="mt-6 pt-6 border-t border-border">
            ...
            <div className="space-y-2 text-xs">
              {[
                ...
                <button key={d.user} type="button" onClick={() => { setUsuario(d.user); setSenha(d.pass); }}
